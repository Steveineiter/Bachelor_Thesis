    ...
    def delete_elements_with_too_large_weight(self, threshold):
        for edge in self.minimum_spanning_tree:
            if edge[WEIGHT] >= threshold:
                self.minimum_spanning_tree.remove(edge)

    def create_cluster(self):
        clusters = list()
        self.minimum_spanning_tree.append([10, 12, 1])# TODO Delte after testing
        self.minimum_spanning_tree.append([12, 14, 2])# TODO Delte after testing
...
if __name__ == "__main__":
    ...
    cluster_analyser.delete_elements_with_too_large_weight(9)
